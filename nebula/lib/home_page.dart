    ...
    if (_error != null) {
      return Column(
        ...
        children: [
          ...
          const Text('Erro ao compilar:', style: TextStyle(fontWeight: FontWeight.bold)),
    ...
    if (_runtime != null) {
      try {
        ...
        final result = _runtime!.executeLib(
          'package:uahca/main.dart',     // Biblioteca
        ...
        return Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            const Text('Erro ao executar:', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            Padding(
              padding: const EdgeInsets.all(20.0),
